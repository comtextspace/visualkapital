...
<article>
	...
	<p class="mt-3 max-w-prose text-ink-soft">
		...
		<code>N</code> получается за тот же день — и эта фиксированная сумма делится уже на большее
	...
	<p class="mt-3 max-w-prose text-ink-soft">
		...
		одной штуки от производительности не зависит — а вот суммарный расход постоянного капитала за день
		растёт вместе с количеством изделий.
	</p>
	<p class="mt-3 max-w-prose text-ink-soft">
		Важно не путать стоимость с массой продукта: рост производительности увеличивает
		<em>количество</em> потребительных стоимостей (штук), но не увеличивает <em>сумму</em> новой стоимости,
		которую живой труд создаёт за день.
	</p>
