...
<article>
	...
	<p class="mt-3 max-w-prose text-ink-soft">
		...
		эксплуатации, тем больше общая масса прибавочной стоимости, хотя каждый из них эксплуатируется
		ровно в той же степени, что и раньше.
	</p>
	...
	<div class="mt-10 space-y-6">
		...
		<div>
			...
			<p class="mt-1 text-xs text-ink-soft">
				...
				два конца одной и той же суммы 1200 ₽. Слайдер <code>L</code> не меняет норму
				<code>m′</code>, только умножает <code>v</code>, <code>m</code> и <code>c</code> на число рабочих.
			</p>
		</div>
	</div>
